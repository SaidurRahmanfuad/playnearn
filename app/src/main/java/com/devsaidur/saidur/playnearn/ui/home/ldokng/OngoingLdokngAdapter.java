...
public class OngoingLdokngAdapter extends RecyclerView.Adapter<OngoingLdokngAdapter.OLKVH> {
    ...
    public OngoingLdokngAdapter(Context context,  List<TopernrModel> topernrsList) {
    ...
    @NonNull
    @Override
    public OLKVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.lay_item_topernr, parent, false);
        OLKVH vh = new OLKVH(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull OLKVH holder, int position) {
